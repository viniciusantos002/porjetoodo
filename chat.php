...
//Cria uma tabela mensagens caso não exista no banco de dados//
        ...
        <div class="chat-container">
            <div class="chat-messages">
                ...
                <script>
                    ...
                    //Essa função realiza uma requisição GET para o chat.php?mensagens=true , ao receber a resposta converte o conteúdo da div com ID mensagens com o novo conteudo recebido do server//
                    ...
                    //Essa função redireciona o navegador para paginaadm.php alterando o valor da propriedade window.location.href//
